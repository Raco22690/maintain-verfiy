        ...
        <div class="dynamic-verify-item" id="verify-item-${verifyItemCounter}">
            <div class="verify-item-content">
                <div class="verify-table-row">
                    ...
                    <div class="verify-field-group target">
                        <input type="text" id="target_${verifyItemCounter}" name="target[]" placeholder="輸入目標參數...">
                    </div>
                    <div class="verify-field-group od">
                        <input type="text" id="od_spec_${verifyItemCounter}" name="od_spec[]" placeholder="規格...">
                    </div>
                    <div class="verify-field-group remark">
                        <textarea id="remark_${verifyItemCounter}" name="remark[]" placeholder="備註說明..."></textarea>
                    </div>
                    <div class="verify-field-group action">
